...
typedef	int32	lid32;		/* semaphore ID				*/
...
typedef uint32	mutex_t;	/* mutual exclusion exists or not */
...
/* activate or deactivate aging policy*/
#define AGING TRUE

/* quantum for our hardware timer in msecs */
#define QUANTUM 10
